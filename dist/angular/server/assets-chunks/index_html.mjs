...
</style><style ng-app-id="ng">.mat-mdc-progress-spinner {
...
</style><style ng-app-id="ng">.mat-pseudo-checkbox {
  border-radius: 2px;
  cursor: pointer;
  display: inline-block;
  vertical-align: middle;
...
</style><style ng-app-id="ng">@keyframes _mat-snack-bar-enter {
  from {
    transform: scale(0.8);
    opacity: 0;
  }
...
</style><style ng-app-id="ng">.mat-mdc-simple-snack-bar {
  display: flex;
}
...
<body>
  <app-root ng-version="21.2.8" ng-server-context="ssg"><app-task-list _nghost-ng-c1537268858><section _ngcontent-ng-c1537268858 class="task-list-container"><div _ngcontent-ng-c1537268858 class="task-header"><h2 _ngcontent-ng-c1537268858>Список завдань</h2><button _ngcontent-ng-c1537268858 mat-raised-button color="primary" class="mdc-button mat-mdc-button-base mdc-button--raised mat-mdc-raised-button mat-primary _mat-animation-noopable" mat-ripple-loader-uninitialized mat-ripple-loader-class-name="mat-mdc-button-ripple"><span class="mat-mdc-button-persistent-ripple mdc-button__ripple"></span><span class="mdc-button__label">Додати завдання</span><span class="mat-focus-indicator"></span><span class="mat-mdc-button-touch-target"></span></button></div><mat-form-field _ngcontent-ng-c1537268858 appearance="outline" class="mat-mdc-form-field mat-mdc-form-field-type-mat-select mat-form-field-appearance-outline mat-primary"><!----><div class="mat-mdc-text-field-wrapper mdc-text-field mdc-text-field--outlined"><!----><div class="mat-mdc-form-field-flex"><div matformfieldnotchedoutline class="mdc-notched-outline mdc-notched-outline--upgraded mdc-notched-outline--notched"><div class="mat-mdc-notch-piece mdc-notched-outline__leading"></div><div class="mat-mdc-notch-piece mdc-notched-outline__notch"><label matformfieldfloatinglabel class="mdc-floating-label mat-mdc-floating-label mdc-floating-label--float-above" id="mat-mdc-form-field-label-0"><mat-label _ngcontent-ng-c1537268858>Фільтр за статусом</mat-label><!----></label><!----><!----><!----></div><div class="mat-mdc-notch-piece mdc-notched-outline__trailing"></div></div><!----><!----><!----><div class="mat-mdc-form-field-infix"><!----><mat-select _ngcontent-ng-c1537268858 role="combobox" aria-haspopup="listbox" class="mat-mdc-select" aria-labelledby="mat-mdc-form-field-label-0" id="mat-select-0" tabindex="0" aria-expanded="false" aria-required="false" aria-disabled="false" aria-invalid="false"><div cdk-overlay-origin class="mat-mdc-select-trigger"><div class="mat-mdc-select-value" id="mat-select-value-0"><!----><span class="mat-mdc-select-value-text"><!----><span class="mat-mdc-select-min-line">Всі</span><!----></span><!----></div><div class="mat-mdc-select-arrow-wrapper"><div class="mat-mdc-select-arrow"><svg viewBox="0 0 24 24" width="24px" height="24px" focusable="false" aria-hidden="true"><path d="M7 10l5 5 5-5z"/></svg></div></div></div><!----></mat-select></div><!----><!----></div><!----></div><div aria-atomic="true" aria-live="polite" class="mat-mdc-form-field-subscript-wrapper mat-mdc-form-field-bottom-align"><!----><div class="mat-mdc-form-field-hint-wrapper"><!----><div class="mat-mdc-form-field-hint-spacer"></div></div><!----></div></mat-form-field><mat-form-field _ngcontent-ng-c1537268858 class="mat-mdc-form-field mat-mdc-form-field-type-mat-input mat-form-field-appearance-fill mat-form-field-hide-placeholder mat-primary ng-untouched ng-pristine ng-valid"><!----><div class="mat-mdc-text-field-wrapper mdc-text-field mdc-text-field--filled"><div class="mat-mdc-form-field-focus-overlay"></div><!----><div class="mat-mdc-form-field-flex"><!----><!----><!----><div class="mat-mdc-form-field-infix"><label matformfieldfloatinglabel class="mdc-floating-label mat-mdc-floating-label" id="mat-mdc-form-field-label-1" for="mat-input-0"><mat-label _ngcontent-ng-c1537268858>Пошук (назва, опис, автор)</mat-label><!----></label><!----><!----><!----><input _ngcontent-ng-c1537268858 matinput type="text" if="filter" class="mat-mdc-input-element ng-untouched ng-pristine ng-valid mat-input-server mat-mdc-form-field-input-control mdc-text-field__input" value id="mat-input-0" aria-invalid="false" aria-required="false"></div><!----><!----></div><div matformfieldlineripple class="mdc-line-ripple mdc-line-ripple--deactivating"></div><!----></div><div aria-atomic="true" aria-live="polite" class="mat-mdc-form-field-subscript-wrapper mat-mdc-form-field-bottom-align"><!----><div class="mat-mdc-form-field-hint-wrapper"><!----><div class="mat-mdc-form-field-hint-spacer"></div></div><!----></div></mat-form-field><div _ngcontent-ng-c1537268858 class="spinner-container"><mat-spinner _ngcontent-ng-c1537268858 role="progressbar" tabindex="-1" class="mat-mdc-progress-spinner mdc-circular-progress mat-primary _mat-animation-noopable mdc-circular-progress--indeterminate" aria-valuemin="0" aria-valuemax="100" mode="indeterminate" style="width: 100px; height: 100px; --mat-progress-spinner-size: 100px; --mat-progress-spinner-active-indicator-width: 100px;"><!----><div aria-hidden="true" class="mdc-circular-progress__determinate-container"><svg xmlns="http://www.w3.org/2000/svg" focusable="false" class="mdc-circular-progress__determinate-circle-graphic" viewBox="0 0 100 100"><circle cx="50%" cy="50%" class="mdc-circular-progress__determinate-circle" style="stroke-dasharray: 282.7433388230814px; stroke-width: 10%;" r="45"/></svg></div><div aria-hidden="true" class="mdc-circular-progress__indeterminate-container"><div class="mdc-circular-progress__spinner-layer"><div class="mdc-circular-progress__circle-clipper mdc-circular-progress__circle-left"><svg xmlns="http://www.w3.org/2000/svg" focusable="false" class="mdc-circular-progress__indeterminate-circle-graphic" viewBox="0 0 100 100"><circle cx="50%" cy="50%" style="stroke-dasharray: 282.7433388230814px; stroke-dashoffset: 141.3716694115407px; stroke-width: 10%;" r="45"/></svg><!----></div><div class="mdc-circular-progress__gap-patch"><svg xmlns="http://www.w3.org/2000/svg" focusable="false" class="mdc-circular-progress__indeterminate-circle-graphic" viewBox="0 0 100 100"><circle cx="50%" cy="50%" style="stroke-dasharray: 282.7433388230814px; stroke-dashoffset: 141.3716694115407px; stroke-width: 10%;" r="45"/></svg><!----></div><div class="mdc-circular-progress__circle-clipper mdc-circular-progress__circle-right"><svg xmlns="http://www.w3.org/2000/svg" focusable="false" class="mdc-circular-progress__indeterminate-circle-graphic" viewBox="0 0 100 100"><circle cx="50%" cy="50%" style="stroke-dasharray: 282.7433388230814px; stroke-dashoffset: 141.3716694115407px; stroke-width: 10%;" r="45"/></svg><!----></div></div></div></mat-spinner></div><!----><!----></section></app-task-list></app-root>
<script src="main-WZUIXVHG.js" type="module"></script>

<div class="cdk-live-announcer-element cdk-visually-hidden" aria-atomic="true" aria-live="polite" id="cdk-live-announcer-0"></div><div class="cdk-overlay-container" platform="server"><div class="cdk-global-overlay-wrapper" dir="ltr"><div id="cdk-overlay-0" class="cdk-overlay-pane"><mat-snack-bar-container class="mdc-snackbar mat-mdc-snack-bar-container error-snackbar mat-snack-bar-container-enter"><div class="mdc-snackbar__surface mat-mdc-snackbar-surface"><div class="mat-mdc-snack-bar-label"><div aria-hidden="true"><simple-snack-bar class="mat-mdc-simple-snack-bar"><div matsnackbarlabel class="mat-mdc-snack-bar-label mdc-snackbar__label"> fetch failed
</div><div matsnackbaractions class="mat-mdc-snack-bar-actions mdc-snackbar__actions"><button matbutton matsnackbaraction class="mdc-button mat-mdc-button-base mat-mdc-snack-bar-action mdc-snackbar__action mat-mdc-button mat-unthemed _mat-animation-noopable" mat-ripple-loader-uninitialized mat-ripple-loader-class-name="mat-mdc-button-ripple"><span class="mat-mdc-button-persistent-ripple mdc-button__ripple"></span><span class="mdc-button__label"> Закрити </span><span class="mat-focus-indicator"></span><span class="mat-mdc-button-touch-target"></span></button></div><!----></simple-snack-bar><!----></div><div aria-live="polite" id="mat-snack-bar-container-live-0"></div></div></div></mat-snack-bar-container></div></div></div></body></html>`;